...
#import "ViewControllerDocC.h"
#import "ViewControllerCircle.h"
@interface ViewControllerDocC ()
@property (nonatomic,strong) ViewControllerCircle *circleVC;
@end

@implementation ViewControllerDocC
...
-(void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender
{
    ...
    if([segue.identifier isEqualToString:@"DocC3Times"] )
        vcCircle.userScale=0.8;
    else if([segue.identifier isEqualToString:@"DocC2Times"] )
